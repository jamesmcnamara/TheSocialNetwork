...
public class ExamplesAlgorithms {
    ...
    public void testKComm9() {
        ...
        Assert.assertEquals(kComm3.size(), 6);
        System.out.println(kComm4);
        ...
        //expected output
        for(int i = 0; i < kCommTester.size(); i++) {
            Assert.assertTrue(kComm3.get(i).equals(kCommTester.get(i)));
        }
    ...
    public void testKComm21() {
        ...
        Assert.assertEquals(kComm6.size(), 12);
        ...
        //expected output
        for(int i = 0; i < kCommTester.size(); i++) {
            Assert.assertTrue(kComm6.get(i).equals(kCommTester.get(i)));
        }
    }
    ...
    public void testKComm101() {
        ...
        Assert.assertEquals(kComm26.size(), 52);
        ...
        //expected output
        for(int i = 0; i < kCommTester.size(); i++) {
            Assert.assertTrue(kComm26.get(i).equals(kCommTester.get(i)));
        }
    }
